const questions = [
  ...
  {q:"ข้อที่ 7: ผลไม้หรือของหวานที่คุณอยากแบ่งกับเรา?", options:["เค้ก","ไอศกรีม","ช็อกโกแลต","ไม่แบ่งเลย...กินคนเดียว"], answer:3},
  {q:"ข้อที่ 8: กิจกรรมที่อยากทำด้วยกันมากที่สุด?", options:["ไปเที่ยว","พาไปรู้จักกับคนที่บ้าน","ทำอาหาร","นอนดูซีรีส์"], answer:1},
  {q:"ข้อที่ 9: เวลาว่างคุณอยากทำอะไรกับเรา?", options:["อ่านหนังสือ","เล่นเกมด้วยกัน","ดูซีรีส์ด้วยกัน","นอน"], answer:3},
